...
const Feed: React.FC<FeedProps> = ({ onLogout }) => {
  ...
  const handleCreatePost = async (e: React.FormEvent) => {
    ...
    try {
      const response = await api.createPost(newPostContent, selectedImage || undefined, isPrivate);
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list ms-auto _mar_r8">
                ...
                <li className="nav-item _header_nav_item">
                  ...
                  <div id="_notify_drop" className={`_notification_dropdown ${notificationDropdownClass}`}>
                  ...
                  <div className="_layout_middle_inner">
                    ...
                    <div className="_feed_inner_area _padd_t24 _padd_b24 _padd_r24 _padd_l24 _b_radious6 _mar_b16">
                        <div className="_feed_inner_post_input">
                          ...
                          <form onSubmit={handleCreatePost} className="w-100">
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                                ...
                                <div className="_feed_inner_text_area_item">
                                  <div className="_feed_inner_text_area_bottom_photo _feed_common">
                                    ...
                                    > 
                                      <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
                                ...
                                <div className="_feed_inner_text_area_btn" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                  <select 
                                    className="form-select form-select-sm" 
                                    style={{ width: 'auto', border: 'none', background: 'transparent', color: '#666', cursor: 'pointer', outline: 'none' }}
